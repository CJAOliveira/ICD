...
def start():
    # Chave de conexao
    cadeia_conexao = 'MINHA CADEIA DE CONEXAO'

    # Acessando os dados da camada RAW
    dados_exames = 'https://storageaccount1404933.blob.core.windows.net/datalake-aulas/raw/DADOS_EXAMES/dados_exames.csv'
    ...
    blob.upload_blob(csv_temp(arquivo_pedido_exames).getvalue(), overwrite=True)
